			...
			<div class="row">
				...
				<div class="col-12">
					<div class="owl-carousel home__carousel">
						...
						$query = "SELECT  movie_id,title, genre, rating, poster_url FROM movies"; // Adjust table/columns as needed
										...
										<div class='card card--big'>
											...
											<div class='card__content'>
												...
												<span class='card__category'>";
														...
														// Assuming categories are stored as comma-separated values
						...
						<img src="http://www.impawards.com/2024/posters/venom_the_last_dance_xlg.jpg" alt="">
						<div class="item">
							<!-- card -->
							<div class="card card--big">
								<div class="card__cover">
