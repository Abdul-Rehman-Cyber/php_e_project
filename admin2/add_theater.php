                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="theater_name" name="name" required>
                                    </div>
                                </div>
                                <!-- movie poster input -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="description" name="address" required>
                                    </div>
                                </div>
                                <!-- movie description input -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="trailer_link" name="capacity" min="1" required>
                                    </div>
                                </div>
                                <!-- movie Trailer_Code input -->
                                    ...
                                    <div class="col-sm-10">
                                        <div class="bg-secondary rounded h-100">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" id="Gold" name="seat_classes[]" value="Gold" required>
                                                <label class="form-check-label" for="Gold">Gold</label>
                                            </div>

                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" id="Platinum" name="seat_classes[]" value="Platinum">
                                                <label class="form-check-label" for="Platinum">Platinum</label>
                                            </div>

                                            <div class="form-check form-check-inline">
                                                <input type="checkbox" class="form-check-input" id="Box" name="seat_classes[]" value="Box">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <button type="submit" name="add" class="btn btn-outline-primary w-100 mb-3">Add Theater</button>
                                    </div>
                                </div>
                                <!-- movie Update button -->
